class Const:
    ...
    INVADER_SIZE = 70
    INVADER_CURVE = 70
    INVADER_HITSIZE = (INVADER_SIZE / 11, INVADER_SIZE / 4.6, - INVADER_SIZE / 6.7, - INVADER_SIZE / 2.5)
    INVADER_RIGHT_BORDER = SCREEN_WIDTH - INVADER_SIZE - INVADER_CURVE
    INVADER_LEFT_BORDER = INVADER_CURVE // 2
